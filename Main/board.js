// Tile events
const events = [
  { name: 'cheetah-smoking', text: 'This is either a really smart move or by far the stupidest thing that we have ever tried. Harold <br> Well, we\'re about to find out." Kumar', event: 24, img: '../Main/images/event-images/cheetah-smoking.png', colour: 'red', index: 1 },
