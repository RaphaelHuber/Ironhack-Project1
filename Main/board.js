// Tile events
const events = [
  { name: 'event1', text: 'Lorem ipsum dolor sit amet, alii esse te vis. Nam eu nobis constituam, dicat ornatus in eos. Electram voluptaria instructior mea an. Sed id audire minimum repudiare. Pro evertitur vituperata ei, ea affert timeam aliquam mel. Est te soluta aliquid, detracto apeirian id nec. No novum aliquam his, suas dissentias.', event: 14, img: '../Main/images/image-event1.png', colour: 'red', index: 1 },
  ...
  { name: 'event3', text: 'Lorem ipsum dolor sit amet, exerci homero eum in, brute nihil deterruisset sit eu. Pri id aliquid deleniti perfecto, eu movet antiopam vix. Tale possit vis an. Pro persecuti suscipiantur interpretaris at. Choro melius at mei. An qui eius possit pertinacia, perfecto periculis cum et. Et has commune placerat vulputate.', event: 19, img: '../Main/images/image-event1.png', colour: 'blue', index: 3 },
  { name: 'event4', text: 'Lorem ipsum dolor sit amet, alii civibus interpretaris vim ne, ceteros omnesque ius cu. Mundi delectus percipit ut mea, at sumo ipsum assum pro, est paulo numquam et? Cu duo paulo conceptam voluptaria, ex diam eros comprehensam mea. No elitr verterem has, qui prima autem mundi ad? Pro te populo.', event: 8, img: '../Main/images/image-event1.png', colour: 'white', index: 9 },
  { name: 'event5', text: 'Lorem ipsum dolor sit amet, reque oblique necessitatibus an sed, cu sale posidonium usu! Labitur fastidii senserit id quo, per ea paulo audire partiendo? His suas idque et. Veri mundi et per, per facer viderer saperet ne. Ut ius tibique volutpat, nam magna autem iuvaret ad. Viris interesset vis ut.', event: -16, img: '../Main/images/image-event1.png', colour: 'grey', index: 20 },
  ...
  { name: 'event8', text: 'Lorem ipsum dolor sit amet, usu equidem fuisset te, qui ut electram forensibus scripserit! Falli facilisis duo ad. An placerat pericula facilisis usu, eam at graeco explicari. Quot nostrum fastidii qui te, no est quando laboramus! Per cu vero rebum fugit, est no eruditi signiferumque, ut mea audiam salutandi! Te.', event: -17, img: '../Main/images/image-event1.png', colour: 'navy', index: 25 },
  { name: 'event9', text: 'Lorem ipsum dolor sit amet, eos et quidam vocent, eos latine intellegebat definitionem at, ne ferri consul his? Antiopam dissentiunt ut mei, sit case laoreet dissentias an? Nobis dolorem blandit nec ea. Duo cu meis ferri dicam, oblique albucius in mel. Civibus eligendi has ne, ei graeci saperet cotidieque vel.', event: 8, img: '../Main/images/image-event1.png', colour: 'silver', index: 29 },
  { name: 'event10', text: 'Lorem ipsum dolor sit amet, nostro quodsi eu eum, per eu altera consulatu urbanitas. Soleat ignota tincidunt quo ut, sea dicta zril ea! Eu solum aliquid interesset sit, qui et decore salutandi argumentum, ea admodum oporteat efficiendi vel? Est ad quas euismod nonumes! No has erant ornatus menandri. Saepe integre.', event: -25, img: '../Main/images/image-event1.png', colour: 'olive', index: 35 },
  { name: 'event11', text: 'Lorem ipsum dolor sit amet, mea id ludus luptatum explicari, appareat persecuti ne mel. Pro cu vide assum constituto, assum animal persecuti vix at. Est te erat accumsan partiendo, an eos audiam prodesset. Eu eirmod malorum facilisi est. Odio evertitur intellegam ut has. Suas nonumy inimicus per ad, salutatus dissentiunt.', event: -8, img: '../Main/images/image-event1.png', colour: 'lime', index: 38 }
];
